nuitka --standalone --mingw64 --show-memory --show-progress ^
    ...
    --windows-product-version=1.0.0 --windows-company-name=DUMMY_WINDOWS_COMPANY_NAME --windows-product-name=BallonsTranslator-lite ^
    --output-dir=release  BallonsTranslator-lite
