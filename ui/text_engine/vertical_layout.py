...
class VerticalTextDocumentLayout(SceneTextLayout):
    # Fork compatibility: the fork-adapted glyph_slant renderer reads
    # ``layout.vertical_rotation_chars`` (the fork vertical layout exposed
    # this set); the engine layout uses the same PUNSET_VERNEEDROTATE set
    # internally via needs_vertical_rotation().
